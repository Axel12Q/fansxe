(() => {
    ...
    let busy = false, activeRequest = null, adminFilter = 'pending', currentStory = null, shelfKey = '', suppressStoryClick = false;
    document.addEventListener('fansxe:story-suppress-click', () => {
        suppressStoryClick = true;
        setTimeout(() => { suppressStoryClick = false; }, 250);
    });
    document.addEventListener('click', event => {
        if (!suppressStoryClick) return;
