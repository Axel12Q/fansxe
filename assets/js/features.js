(() => {
    ...
    document.addEventListener('click', async event => {
        ...
        switch (button.dataset.feature) {
            ...
            case 'story-like': if (community.state.stories.find(s => s.id === currentStory)?.creatorId === 'demo') break; if (!(window.FansxeBoot ? await community.toggleStoryLike(currentStory) : community.toggleStoryLike(currentStory))) app.notify('La historia ya no está disponible.'); break;
